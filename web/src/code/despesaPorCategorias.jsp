...
try {
    ...
    String query = "SELECT t.id_categoria, c.nome, c.cor, sum(t.valor) AS despesa FROM transacao t INNER JOIN categoria c ON t.id_categoria = c.id_categoria WHERE t.id_tipo_transacao = 1 AND t.id_usuario = "+idusuario+" GROUP BY t.id_categoria, c.nome, c.cor";
    ...
    while(rs.next()) {
        ...
        json.put("value", rs.getDouble("despesa"));
